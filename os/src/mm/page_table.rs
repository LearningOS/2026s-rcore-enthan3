...
impl PageTableEntry {
    ...
    /// The page pointed by page table entry is accessible in U mode?
...
/// Translate a user buffer with permission checking.
/// `for_write = false` requires `U | R`;
/// `for_write = true` requires `U | W`.
